        ...
        <div className="grid gap-10">
          <div className="space-y-4 text-center">
            ...
            <p className="max-w-3xl mx-auto text-muted-foreground md:text-xl/relaxed">
              Have a project in mind, a job opportunity, or just want to say hi? I'd love to hear from you. Reach out via email, phone, or social media.
            </p>
            <div className="space-y-2">
              ...
              <div className="text-muted-foreground">
                ...
                <p>
                  Phone: <a href="tel:+919867027286" className="text-primary hover:underline">9867027286</a>
                </p>
              </div>
            </div>
